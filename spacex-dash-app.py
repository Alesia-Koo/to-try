...
def get_pie_chart(site_dropdown):
    if site_dropdown == 'ALL' or site_dropdown =='None':
        ...
        f_d = spacex_df.loc[spacex_df['Launch Site'] == site_dropdown]
        fig = px.pie(f_d, names='class', title='Total Sucessful Launches for Site' + site_dropdown)
    return fig
...
def get_scatter_chart(site_dropdown, payload_slider):
    ...
    if (site_dropdown == 'ALL' or site_dropdown == 'None'):
        ...
        l,h = payload_slider
        f_d = spacex_df[spacex_df['Payload Mass (kg)'].between(l,h)]
        filtered = f_d[f_d['Launch Site'] == site_dropdown]
        fig = px.scatter(
                filtered,
                x = "Payload Mass (kg)",
                y = "class",
